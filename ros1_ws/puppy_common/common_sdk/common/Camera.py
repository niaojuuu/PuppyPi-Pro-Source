...
#这是一个用Opencv获取usb摄像头的画面的封装库(this is a wrapper library for capturing video from a USB camera using OpenCV)
...
class Camera:
    def __init__(self, resolution=(640, 480)):
        ...
        # 以子线程的形式获取图像(obtain image in a sub-thread format)
