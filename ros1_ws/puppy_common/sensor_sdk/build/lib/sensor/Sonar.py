...
class Sonar:
    ...
    #设置灯的模式，0为彩灯模式，1为呼吸灯模式(set the light mode, 0 is color light mode, 1 is breathing light mode)
    ...
    #参数1：0表示左边的灯，1表示右边(parameter 1: 0 indicates the left light, 1 indicates the right light)
    ...
    #参数1：0表示左边的灯，1表示右边(parameter 1: 0 indicates the left light, 1 indicates the right light)
    #参数2：颜色通道， 0表示然，1表示g， 2表示b(parameter 2: color channel, 0 indicates r, 1 indicates g, 2 indicates b)
    #参数3：颜色变化周期，单位ms(parameter 3: color color change cycle, in milliseconds)
