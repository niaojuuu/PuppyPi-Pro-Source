...
class PacketFunction(enum.IntEnum):
    ...
    PACKET_FUNC_PWM_SERVO = 4  # PWM舵机控制, 板子上从里到外依次为1-4(PWM servo control, the number are 1-4 from inside to out of the board)
    ...
    PACKET_FUNC_SBUS = 9  # 航模遥控获取(remote control of model aircraft)
